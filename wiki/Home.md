...
A [Foundry VTT](https://foundryvtt.com/) game system implementing the
[OpenD6 Project SRD](http://opend6project.org) and content from the
[OpenD6 Space rulebook](https://ogc.rpglibrary.org/index.php?title=OpenD6).
...
- **[Features](Features)** — what the system supports out of the box.
- **[System Settings](System-Settings)** — tour of every settings menu under
  *Game Settings → Configure Settings → System Settings*.
- **[Troubleshooting](Troubleshooting)** — installing PR preview builds,
  common configuration issues, where to file bugs.
...
Older system releases targeted v10–v13 and are no longer supported.
